...
fun main(args: Array<String>) {
    ...
    generateFor(getUrl("week_standings_bootstrap.json")!!, "Standings", "org.nfllook.tools.generated.wst")
    generateFor(getUrl("week_schedule.json")!!, "Schedule", "org.nfllook.tools.generated.wsch")
}
