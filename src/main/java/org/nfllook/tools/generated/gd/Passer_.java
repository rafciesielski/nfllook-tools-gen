...
public class Passer_ {
    ...
    public Passer_ withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Passer_ withAtt(Integer att) {
        this.att = att;
        return this;
    }
    ...
    public Passer_ withCmp(Integer cmp) {
        this.cmp = cmp;
        return this;
    }
    ...
    public Passer_ withYds(Integer yds) {
        this.yds = yds;
        return this;
    }
    ...
    public Passer_ withTds(Integer tds) {
        this.tds = tds;
        return this;
    }
    ...
    public Passer_ withInts(Integer ints) {
        this.ints = ints;
        return this;
    }
    ...
    public Passer_ withTwopta(Integer twopta) {
        this.twopta = twopta;
        return this;
    }
    ...
    public Passer_ withTwoptm(Integer twoptm) {
        this.twoptm = twoptm;
        return this;
    }
    ...
    public Passer_ withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Passer_) == false) {
            return false;
        }
        Passer_ rhs = ((Passer_) other);
