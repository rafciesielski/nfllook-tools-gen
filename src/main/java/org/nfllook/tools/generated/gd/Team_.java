...
public class Team_ {
    ...
    public Team_ withTotfd(Integer totfd) {
        this.totfd = totfd;
        return this;
    }
    ...
    public Team_ withTotyds(Integer totyds) {
        this.totyds = totyds;
        return this;
    }
    ...
    public Team_ withPyds(Integer pyds) {
        this.pyds = pyds;
        return this;
    }
    ...
    public Team_ withRyds(Integer ryds) {
        this.ryds = ryds;
        return this;
    }
    ...
    public Team_ withPen(Integer pen) {
        this.pen = pen;
        return this;
    }
    ...
    public Team_ withPenyds(Integer penyds) {
        this.penyds = penyds;
        return this;
    }
    ...
    public Team_ withTrnovr(Integer trnovr) {
        this.trnovr = trnovr;
        return this;
    }
    ...
    public Team_ withPt(Integer pt) {
        this.pt = pt;
        return this;
    }
    ...
    public Team_ withPtyds(Integer ptyds) {
        this.ptyds = ptyds;
        return this;
    }
    ...
    public Team_ withPtavg(Integer ptavg) {
        this.ptavg = ptavg;
        return this;
    }
    ...
    public Team_ withTop(String top) {
        this.top = top;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Team_) == false) {
            return false;
        }
        Team_ rhs = ((Team_) other);
