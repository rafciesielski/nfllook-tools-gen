...
public class Defender_ {
    ...
    public Defender_ withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Defender_ withTkl(Integer tkl) {
        this.tkl = tkl;
        return this;
    }
    ...
    public Defender_ withAst(Integer ast) {
        this.ast = ast;
        return this;
    }
    ...
    public Defender_ withSk(Integer sk) {
        this.sk = sk;
        return this;
    }
    ...
    public Defender_ withInt(Integer _int) {
        this._int = _int;
        return this;
    }
    ...
    public Defender_ withFfum(Integer ffum) {
        this.ffum = ffum;
        return this;
    }
    ...
    public Defender_ withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Defender_) == false) {
            return false;
        }
        Defender_ rhs = ((Defender_) other);
